...
export function PlayerBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-surface border-t border-border z-50" data-testid="player-bar-element">
      ...
      <div className="hidden md:flex items-center h-20 px-4 gap-4">
        ...
        <div className="flex flex-col items-center gap-1 flex-1 max-w-lg mx-auto">
          ...
          <div className="flex items-center gap-2 w-full">
            ...
            <Slider
              ...
              max={durationMs || 1}
              step={1000}
              onValueCommitted={(value) => seek.mutate({ positionMs: Array.isArray(value) ? value[0] : value })}
              className="flex-1"
        ...
        <div className="flex items-center gap-2 w-36 shrink-0 justify-end">
          ...
          <Slider
            ...
            max={100}
            step={1}
            onValueCommitted={(value) => setVolume.mutate({ volumePercent: Array.isArray(value) ? value[0] : value })}
            className="w-24"
            aria-label="Volume"
          />
        </div>
