...
export function PlayIcon() {
  return (
    <svg role="img" viewBox="0 0 16 16" style={{ fill: "black", height: "1.15em", cursor: "pointer" }}>
...
export function QueueIcon() {
  return (
    <svg viewBox="0 0 16 16" style={smallIconStyle()}>
...
export function ConnectDevicesIcon() {
  return (
    <svg viewBox="0 0 16 16" style={smallIconStyle()}>
...
export function LyricsQueueIcon() {
  return (
    <svg viewBox="0 0 16 16" style={smallIconStyle()}>
...
export function MiniPlayerIcon() {
  return (
    <svg viewBox="0 0 16 16" style={smallIconStyle({ cursor: undefined })}>
...
export function ExpandIcon() {
  return (
    <svg viewBox="0 0 24 24" style={smallIconStyle()}>
